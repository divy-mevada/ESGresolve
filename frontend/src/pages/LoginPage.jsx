  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white border-2 border-moss shadow-[8px_8px_0px_0px_#A1BC98] rounded-sm p-8">
        ...
        <p className="text-center text-moss/70 font-medium mb-8">SIGN IN TO YOUR ACCOUNT</p>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500 font-medium uppercase tracking-wider">Or continue with</span>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-moss font-medium">
          ...
          <Link to="/signup" className="text-leaf hover:text-moss font-bold underline decoration-2">
            Sign up
          </Link>
        </p>
